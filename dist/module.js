...
var ConfigEditor = function (_super) {
  ...
  function ConfigEditor() {
    ...
    _this.onScriptChange = function (event) {
      var _a = _this.props,
  ...
  ConfigEditor.prototype.render = function () {
    var options = this.props.options; //const { jsonData } = options;

    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Label"], {
      className: "width-10",
      description: "Used by Handlebars"
    }, "Global function"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("textarea", {
...
var DataSource = function (_super) {
  ...
  DataSource.prototype.getQueryDisplayText = function (query) {
    if (!query || !query.body) {
      return 'Missing Query';
    }

    return lodash_truncate__WEBPACK_IMPORTED_MODULE_4___default()(query.body, {
      length: 20
    });
  };
  ...
  DataSource.prototype.doAllQueries = function (options) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      function replaceVariables(ctxt, value) {
        var template = handlebars__WEBPACK_IMPORTED_MODULE_6___default.a.compile(value);
        var res = template(context);
        res = ctxt.templateSrv.replace(res, options.scopedVars);
        return res;
      }

      var func_1, context, promises, results, data, appEvents;
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            console.log(options); //If global script for Handlebars exists

            if (this.instanceSettings.jsonData.script && this.instanceSettings.jsonData.script != '') {
              func_1 = new Function('text,options', this.instanceSettings.jsonData.script);
              handlebars__WEBPACK_IMPORTED_MODULE_6___default.a.registerHelper('function', function (text, opts) {
                var result = func_1(text, opts);
                return result;
              });
            }
            ...
            this.templateSrv.variables.forEach(function (elt) {
              context[elt.name] = elt.current.text;
            });
            console.log(context);
            promises = options.targets.map(function (target) {
              return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
                var query, opts, url, res, json, processed, f;
                return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      query = lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()(target, _types__WEBPACK_IMPORTED_MODULE_2__["defaultQuery"]);
                      console.log(query);
                      opts = {
                        method: query.method
                      };
                      ...
                      url = replaceVariables(this, query.url);
                      return [4
                      /*yield*/
                      , fetch(url, opts)];
                    ...
                    case 2:
                      ...
                      try {
                        if (query.script && query.script !== '') {
                          f = new Function('data,variables', query.script);
                          processed = f(json);
                        } else {
                          processed = json;
                        }
          ...
          case 1:
            results = _a.sent();
            data = results.map(function (elt) {
              return elt.processed;
            });
            console.log(data); //data===[undefined]. I don't know when it happens but sometimes it happens... so here is a fix

            if (data.length == 1 && data[0] === undefined) data = [];
            return [4
            /*yield*/
            , _grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["SystemJS"].load('app/core/app_events')];

          case 2:
            appEvents = _a.sent();
            appEvents.emit('ds-request-response', results); //I should use getBackendSrv().datasourceRequest function but I don't know how to display the result of all the queries simultenaously in the uery inspector
  ...
  DataSource.prototype.testDatasource = function () {
    var url = this.instanceSettings.url;
...
var QueryEditor = function (_super) {
  ...
  function QueryEditor() {
    ...
    _this.onMethodChange = function (value) {
    ...
    _this.onHeadersChange = function (headers) {
    ...
    _this.onBodyChange = function (body) {
    ...
    _this.onScriptChange = function (script) {
  ...
  QueryEditor.prototype.render = function () {
    ...
    var query = lodash_defaults__WEBPACK_IMPORTED_MODULE_2___default()(this.props.query, _types__WEBPACK_IMPORTED_MODULE_3__["defaultQuery"]);
    var url = query.url,
        body = query.body,
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Field"], {
      label: "Url"
    ...
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Label"], {
      className: "width-12",
      description: "Choose an HTTP method."
    }, "Method"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Select"], {
      value: method ? {
        label: method,
        value: method
      } : {
      ...
      className: "width-12",
      description: "Set headers of HTTP request"
    }, "Headers"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["CodeEditor"], {
      language: "json",
    ...
    })), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), method === 'POST' && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      className: "gf-form"
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Label"], {
      className: "width-12",
      description: "Set body of HTTP request"
    }, "Body")), method === 'POST' && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      style: {
        width: '100%'
      }
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["CodeEditor"], {
      language: "json",
      showLineNumbers: true,
      value: body,
      width: "100%",
    ...
    })), method === 'POST' && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      style: {
        width: '100%'
      }
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Label"], {
      description: "Set script to return formatted data as described in Grafana's documentation"
    }, "Script"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["CodeEditor"], {
      language: "javascript",
      showLineNumbers: true,
      value: script,
      width: "100%",
...
var plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_0__["DataSourcePlugin"](_DataSource__WEBPACK_IMPORTED_MODULE_1__["DataSource"]).setConfigEditor(_ConfigEditor__WEBPACK_IMPORTED_MODULE_3__["ConfigEditor"]) //.setVariableQueryEditor
.setQueryEditor(_QueryEditor__WEBPACK_IMPORTED_MODULE_2__["QueryEditor"]);
